...
<table width="913" border="0" height="34" cellspacing="0">
  <tr>
    ...
    <td background="title_middle.jpg" width="860">
      <div align="left"><font color="#FFFFFF" size="3"><b><span class="Tahoma14">Modification de personnage</span></b></font> </div>
    </td>
...
<?
   echo "<FORM Method=\"GET\" Action=\"modifychar.php3\">";
   ...
   if ($aChar->race == "High-Elf")
     echo '<option value="High-Elf" selected>High-Elf';
   else
     echo '<option value="High-Elf">High-Elf';
...
echo 'Sebilis key ? : <select name=pcSeb>';
if ($aChar->Seb == 1)
{
    echo '         <option value="Non">Non';
	echo '         <option value="Oui" selected>Oui';
...
echo 'Howling Stones key ? : <select name=pcHS>';
if ($aChar->HS == 1)
{
    echo '         <option value="Non">Non';
	echo '         <option value="Oui" selected>Oui';
...
echo 'Veeshan Peek key ? : <select name=pcVP>';
if ($aChar->VP == 1)
{
    echo '         <option value="Non">Non';
	echo '         <option value="Oui" selected>Oui';
...
echo 'Sleepers Tomb key ? : <select name=pcST>';
if ($aChar->ST == 1)
{
    echo '         <option value="Non">Non';
	echo '         <option value="Oui" selected>Oui';
...
echo 'PoV/Pos flag ? : <select name=pcPoVPoS>';
if ($aChar->PoVPoS == 1)
{
    echo '         <option value="Non">Non';
        echo '         <option value="Oui" selected>Oui';
...
echo 'Bastion of Thunder flag ? : <select name=pcBoT>';
if ($aChar->BoT == 1)
{
    echo '         <option value="Non">Non';
	echo '         <option value="Oui" selected>Oui';
...
echo 'Hall of Honors XP flag ? : <select name=pcHoHxp>';
if ($aChar->HoHxp == 1)
{
    echo '         <option value="Non">Non';
	echo '         <option value="Oui" selected>Oui';
...
echo 'Lair of Terris Thule flag ? : <select name=pcLoTT>';
if ($aChar->LoTT == 1)
{
    echo '         <option value="Non">Non';
	echo '         <option value="Oui" selected>Oui';
