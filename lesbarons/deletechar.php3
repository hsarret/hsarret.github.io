...
{
  include "deletechar_fail_session.php3";
  exit();
}
...
{
  include "deletechar_fail_user.php3";
  exit();
}
...
{
  // failure page
  include "deletechar_fail_notfound.php3";
  exit();
}
...
if (!$result)
{
  include "deletechar_fail.php3";
  exit();
}

// Affiche le message de succes
include "deletechar_success.php3";
